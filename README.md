...
| **Врачи**     | ✅ готово   | Таблица, CRUD, поиск, сортировка, пагинация, карточка с расписанием |
...
Карточка пациента пока без вкладок визитов / записей / платежей (добавятся после модуля записей).
...
├── widgets/          # sidebar, header, patient/doctor tables & cards
...
- [x] **Этап 4** — Карточка врача и отображение расписания
...
/doctors/:id               → карточка врача (профиль + расписание)
